...
public class ForensicChamberScreen extends GuiConfigurableTile<ForensicChamberBlockEntity, ForensicChamberMenu> {
    ...
    private static final ResourceLocation MEMORY_CHIP_GHOST_TEXTURE = new ResourceLocation("replicatemekanism", "textures/gui/memory_chip_ghost.png");
    ...
    protected void addGuiElements() {
        ...
        this.addRenderableWidget(new ReplicationGuiVerticalPowerBar(this, tile.energyContainer, 162, 22, 52));
